  ...
  void article() async {
    try {
      await FirebaseFirestore.instance
          .collection("article")  // Ensure the collection "article" exists
          .get()
          .then((querySnapshot) {
        if (querySnapshot.docs.isNotEmpty) {
          querySnapshot.docs.reversed.forEach((element) {
            print(element.data()['body']);  // Ensure that "title" field exists in documents
          });
        } else {
      ...
      print("Error fetching articles: $e");  // Catch any errors during Firestore query
    }
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Keshav is a data-analyst. He is pursuing mechanical engineering from NIT, Calicut with a current CGPA of 7.4. He is proficient with SQL, Power BI and excel. He has successfully completed his 6 weeks internship at HPCL-Visakh Refinery.",
